      ...
      <div className='max-w-2xl mx-auto p-3 text-center'>
        <div>
          <h1 className='text-3xl font font-semibold text-center my-7'>
            About Inko Jaya Konstruksi
          </h1>
          <div className='text-md text-gray-500 flex flex-col gap-6'>
            <p>
              Welcome to Inko Jaya Konstruksi! Created by Inko Jaya Konstruksi, this blog
              serves as a personal platform to share his insights and ideas with
              the world. Inko Jaya Konstruksi is an enthusiastic developer who enjoys writing
            ...
            <p>
              ...
              engineering, and programming languages. Inko Jaya Konstruksi is continually
